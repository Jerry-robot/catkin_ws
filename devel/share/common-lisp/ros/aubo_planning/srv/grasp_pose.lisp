...
(cl:in-package aubo_planning-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <grasp_pose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'grasp_pose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aubo_planning-srv:<grasp_pose-request> is deprecated: use aubo_planning-srv:grasp_pose-request instead.")))

(cl:ensure-generic-function 'grasppose_x-val :lambda-list '(m))
(cl:defmethod grasppose_x-val ((m <grasp_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_planning-srv:grasppose_x-val is deprecated.  Use aubo_planning-srv:grasppose_x instead.")
  (grasppose_x m))

(cl:ensure-generic-function 'grasppose_y-val :lambda-list '(m))
(cl:defmethod grasppose_y-val ((m <grasp_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_planning-srv:grasppose_y-val is deprecated.  Use aubo_planning-srv:grasppose_y instead.")
  (grasppose_y m))

(cl:ensure-generic-function 'grasppose_z-val :lambda-list '(m))
(cl:defmethod grasppose_z-val ((m <grasp_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_planning-srv:grasppose_z-val is deprecated.  Use aubo_planning-srv:grasppose_z instead.")
  (grasppose_z m))

(cl:ensure-generic-function 'grasppose_R-val :lambda-list '(m))
(cl:defmethod grasppose_R-val ((m <grasp_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_planning-srv:grasppose_R-val is deprecated.  Use aubo_planning-srv:grasppose_R instead.")
  (grasppose_R m))

(cl:ensure-generic-function 'grasppose_P-val :lambda-list '(m))
(cl:defmethod grasppose_P-val ((m <grasp_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_planning-srv:grasppose_P-val is deprecated.  Use aubo_planning-srv:grasppose_P instead.")
  (grasppose_P m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<grasp_pose-request>)))
  ...
  "aubo_planning/grasp_poseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'grasp_pose-request)))
  "Returns string type for a service object of type 'grasp_pose-request"
  "aubo_planning/grasp_poseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <grasp_pose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'grasp_pose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aubo_planning-srv:<grasp_pose-response> is deprecated: use aubo_planning-srv:grasp_pose-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <grasp_pose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_planning-srv:success-val is deprecated.  Use aubo_planning-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<grasp_pose-response>)))
  ...
  "aubo_planning/grasp_poseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'grasp_pose-response)))
  "Returns string type for a service object of type 'grasp_pose-response"
  "aubo_planning/grasp_poseResponse")
